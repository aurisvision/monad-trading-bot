...
class Area51BotModularSimple {
    ...
    async initializeComponents() {
        ...
        // Initialize services
        // API Strategy:
        // - MonorailAPI: Used for balance queries (getMONBalance), price queries (getTokenPriceInMON), portfolio data, and trading operations
        ...
        const groupDependencies = {
            ...
            walletManager: this.walletManager,
            cacheService: this.cacheService,
            botUsername: this.bot.botInfo?.username || 'MonAreaBot'
        };
